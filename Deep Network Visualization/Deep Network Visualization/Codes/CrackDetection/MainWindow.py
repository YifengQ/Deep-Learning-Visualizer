...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.DecoderPicture.setMinimumSize(QtCore.QSize(0, 100))
        ...
        self.trainButton.clicked.connect(self.on_click)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_labeledData_2.setText(_translate("MainWindow", "Labeled Data Location"))
        ...
        self.networkOverviewDescription.setText(_translate("MainWindow", "DESCRIPTION FOR MAIN WINDOW USE IMAGINATION"))
        ...
        self.encoderDescription.setText(_translate("MainWindow", "DESCRIPTION FOR ENCODER WINDOW USE IMAGINATION"))
        ...
        self.decoderDescription.setText(_translate("MainWindow", "DESCRIPTION FOR DECODER WINDOW USE IMAGINATION"))
    ...
    def validateNumericInput(self):
        ...
        if self.LREntry.text() is "" or self.LREntry.text().isdigit() or float(self.LREntry.text()) < 0 or float(self.LREntry.text()) > 1:
            success = False
        ...
        # drop rate
        if self.dropRateInput.text() is "" or self.dropRateInput.text().isdigit() or float(self.dropRateInput.text()) < 0 or float(self.dropRateInput.text()) > 1:
            success = False
    ...
    # function to validate text based entries.
    ...
    def validateLogic(self):
        ...
        #test[len(test)-1] = test[len(test)-1].replace(')','')
        #print(test)